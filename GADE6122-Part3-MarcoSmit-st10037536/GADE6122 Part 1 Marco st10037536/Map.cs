...
namespace GADE6122_Part_1_Marco_st10037536
{
    internal class Map
    {
        ...
        public static readonly string HERO = "H", SWAMP_CREATURE = "E", EMPTY = "_", OBSTACLE = "•", MAGE = "M", GOLD = "G", LEADER = "L", WEAPON = "W";
        ...
        public Leader[] Leader { get { return leader; } set { leader = value; } }

        public Map(int minWidth, int maxWidth, int minHeight, int maxHeight, int enemyCount, int goldCount, int leaderCount)
        {
            mapWidth = rand.Next(minWidth, maxWidth);
            mapHeight = rand.Next(minHeight, maxHeight);

            enemies = new Enemy[enemyCount];
            Leader[] leaders = new Leader[leaderCount];
